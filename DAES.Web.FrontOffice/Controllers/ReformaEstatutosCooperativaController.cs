...
{
    [Audit]
    public class ReformaEstatutosCooperativaController : Controller
    {
        ...
        public ActionResult Create(int id)
        {
            ...
            return View(new Model.DTO.DTOReformaEstatutosCooperativa()
            {
        ...
        public ActionResult Create(Model.DTO.DTOReformaEstatutosCooperativa model)
        {
            if (!Global.CurrentClaveUnica.IsAutenticated)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    DefinicionProcesoId = (int)Infrastructure.Enum.DefinicionProceso.ReformaEstatutosCooperativa,
                    OrganizacionId = model.OrganizacionId
                };
