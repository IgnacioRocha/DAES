...
{
    [Audit]
    public class TransformacionCooperativaController : Controller
    {
        ...
        {
            Global.CurrentClaveUnica.ClaveUnicaRequestAutorization.controller = "TransformacionCooperativa";
        ...
        public ActionResult Create(int id)
        {
            ...
            return View(new Model.DTO.DTOTransformacionCooperativa()
            {
        ...
        public ActionResult Create(Model.DTO.DTOTransformacionCooperativa model)
        {
            if (!Global.CurrentClaveUnica.IsAutenticated)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    DefinicionProcesoId = (int)Infrastructure.Enum.DefinicionProceso.TransformacionCooperativa,
                    OrganizacionId = model.OrganizacionId
                };
