...
namespace DAES.Web.FrontOffice.Controllers
{
    ...
    [Audit]
    public class FusionCooperativaController : Controller
    {
        ...
        {
            Global.CurrentClaveUnica.ClaveUnicaRequestAutorization.controller = "FusionCooperativa";
        ...
        public ActionResult Create(int id)
        {
            ...
            return View(new Model.DTO.DTOFusionCooperativa()
            {
        ...
        public ActionResult Create(Model.DTO.DTOFusionCooperativa model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    DefinicionProcesoId = (int)Infrastructure.Enum.DefinicionProceso.FusionCooperativa,
                    OrganizacionId = model.OrganizacionId
                };
