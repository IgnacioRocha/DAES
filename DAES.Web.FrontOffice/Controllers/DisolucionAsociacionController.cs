...
namespace DAES.Web.FrontOffice.Controllers
{
    ...
    [Audit]
    public class DisolucionAsociacionController : Controller
    {
        ...
        {
            Global.CurrentClaveUnica.ClaveUnicaRequestAutorization.controller = "DisolucionAsociacion";
        ...
        public ActionResult Create(int id)
        {
            ...
            return View(new Model.DTO.DTODisolucionAsociacion()
            {
        ...
        public ActionResult Create(Model.DTO.DTODisolucionAsociacion model)
        {
            if (!Global.CurrentClaveUnica.IsAutenticated)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    DefinicionProcesoId = (int)Infrastructure.Enum.DefinicionProceso.DisolucionAsociacion,
                    OrganizacionId = model.OrganizacionId
                };
