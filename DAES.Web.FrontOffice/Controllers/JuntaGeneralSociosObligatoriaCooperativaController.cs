...
namespace DAES.Web.FrontOffice.Controllers
{
    ...
    [Audit]
    public class JuntaGeneralSociosObligatoriaCooperativaController : Controller
    {
        ...
        private static DTOJuntaGeneralSociosObligatoriaCooperativa model = new DTOJuntaGeneralSociosObligatoriaCooperativa();
        ...
        public ActionResult Create(int id)
        {
            ...
            model = new DTOJuntaGeneralSociosObligatoriaCooperativa
            {
        ...
        public ActionResult Create(DTOJuntaGeneralSociosObligatoriaCooperativa model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    DefinicionProcesoId = (int)Infrastructure.Enum.DefinicionProceso.JuntaGeneralSociosObligatoriaCooperativa,
        ...
        public ActionResult DirectorioAdd()
        {
            ...
            return PartialView("_JuntaGeneralSociosObligatoriaCooperativaDirectorioEdit", model);
        }
