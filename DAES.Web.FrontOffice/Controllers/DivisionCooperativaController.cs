...
namespace DAES.Web.FrontOffice.Controllers
{
    ...
    [Audit]
    public class DivisionCooperativaController : Controller {
        ...
        {
            Global.CurrentClaveUnica.ClaveUnicaRequestAutorization.controller = "DivisionCooperativa";
        ...
        public ActionResult Create(int id) {
            ...
            return View(new Model.DTO.DTODivisionCooperativa() {
        ...
        public ActionResult Create(Model.DTO.DTODivisionCooperativa model) {
            ...
            if (ModelState.IsValid) {
                var proceso = new Proceso() {
                    DefinicionProcesoId = (int)Infrastructure.Enum.DefinicionProceso.DivisionCooperativa,
                    OrganizacionId = model.OrganizacionId
                };
