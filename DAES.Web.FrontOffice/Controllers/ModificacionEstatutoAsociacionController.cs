...
{
    [Audit]
    public class ModificacionEstatutoAsociacionController : Controller
    {
        ...
        {
            Global.CurrentClaveUnica.ClaveUnicaRequestAutorization.controller = "ModificacionEstatutoAsociacion";
        ...
        public ActionResult Create(int id)
        {
            ...
            return View(new Model.DTO.DTOModificacionEstatutoAsociacion()
            {
        ...
        public ActionResult Create(Model.DTO.DTOModificacionEstatutoAsociacion model)
        {
            if (!Global.CurrentClaveUnica.IsAutenticated)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    DefinicionProcesoId = (int)Infrastructure.Enum.DefinicionProceso.ModificacionEstatutoAsociacion,
                    OrganizacionId = model.OrganizacionId
                };
