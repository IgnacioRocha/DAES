...
namespace DAES.Web.FrontOffice.Controllers
{
    ...
    [Audit]
    public class AsambleaExtraOrdinariaAsociacionController : Controller
    {
        ...
        private static DTOAsambleaExtraOrdinaria model = new DTOAsambleaExtraOrdinaria();
        ...
        {
            Global.CurrentClaveUnica.ClaveUnicaRequestAutorization.controller = "AsambleaExtraOrdinariaAsociacion";
        ...
        public ActionResult Create(int id)
        {
            ...
            model = new Model.DTO.DTOAsambleaExtraOrdinaria
            {
                ...
                FechaPublicacionDiarioOficial = organizacion.FechaPublicacionDiarioOficial,
        ...
        public ActionResult Create(DTOAsambleaExtraOrdinaria model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    DefinicionProcesoId = (int)Infrastructure.Enum.DefinicionProceso.AsambleaExtraOrdinariaAsociacion,
        ...
        public ActionResult DirectorioAdd()
        {
            ...
            return PartialView("_AsambleaExtraOrdinariaAsociacionDirectorioEdit", model);
        }
