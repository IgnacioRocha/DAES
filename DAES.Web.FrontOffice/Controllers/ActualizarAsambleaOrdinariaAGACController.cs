...
{
    [Audit]
    public class ActualizarAsambleaOrdinariaAGACController : Controller
    {
        ...
        private static DTOAsambleaOrdinariaDirectorio model = new DTOAsambleaOrdinariaDirectorio();


        // GET: ActualizarAsambleOrdinariaAGAC
        ...
        public ActionResult Search(string Filter)
        {
            ...
            query = query.Where(q => q.TipoOrganizacionId == (int)Infrastructure.Enum.TipoOrganizacion.AsociacionConsumidores || q.TipoOrganizacionId == (int)Infrastructure.Enum.TipoOrganizacion.AsociacionGremial);
        ...
        // GET: ActualizarAsambleOrdinariaAGAC/Create
        ...
        public ActionResult Create(DTOAsambleaOrdinariaDirectorio model, List<string> NombreCompleto, List<string> Rut, List<int?> SelectCargo, List<int?> SelectGenero, List<string> FechaInicio, List<string> FechaTermino, List<int?> IdSolicitante, List<int?> Eliminado, List<int?> DirectorioId)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    //Definicion ProcesoID => 86
                    DefinicionProcesoId = (int)Infrastructure.Enum.DefinicionProceso.AsambleaOrdinaria,
        ...
        public ActionResult DirectorioAdd()
        {
            ...
            return PartialView("_ActualizarAsambleaOrdinariaAGAC", model);
        }
