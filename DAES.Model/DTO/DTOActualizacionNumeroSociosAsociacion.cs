...
{
    public class DTOActualizacionNumeroSociosAsociacion : DTOSolicitante
    {
        public DTOActualizacionNumeroSociosAsociacion()
        {
        ...
        [Required(ErrorMessage = "Es necesario especificar el dato Socios hombres")]
        [Display(Name = "Socios hombres")]
        public int? NumeroSociosHombres { get; set; }

        [Required(ErrorMessage = "Es necesario especificar el dato Socios mujeres")]
        ...
        [Required(ErrorMessage = "Es necesario especificar el dato Listado a remitir cada 2 años")]
        [Display(Name = "Listado a remitir cada 2 años")]
