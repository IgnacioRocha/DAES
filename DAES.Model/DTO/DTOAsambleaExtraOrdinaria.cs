...
{
    public class DTOAsambleaExtraOrdinaria : DTOSolicitante
    {
        public DTOAsambleaExtraOrdinaria()
        {
        ...
        [Display(Name = "Acta de asamblea extraordinaria")]
        [DataType(DataType.Upload)]
        public HttpPostedFileBase ActaAsambleaExtraordinaria { get; set; }

        [Required(ErrorMessage = "Es necesario especificar este dato")]
        [Display(Name = "Comprobante de medios de convocatorias empleadas")]
        [DataType(DataType.Upload)]
        public HttpPostedFileBase ComprobanteMedios { get; set; }

        [Required(ErrorMessage = "Es necesario especificar este dato")]
        [Display(Name = "Listado de asistencia")]
        [DataType(DataType.Upload)]
        public HttpPostedFileBase ListadoAsistencias { get; set; }
