...
namespace DAES.Model.DTO
{
    public class DTOJuntaGeneralSociosCoop : DTOSolicitanteCore
    {
        ...
        [Required(ErrorMessage = "Es necesario especificar el dato Acta de la Junta General de Socios")]
        [Display(Name = "(*) Acta de Junta General de Socios")]
        [DataType(DataType.Upload)]
        public HttpPostedFileBase File1 { get; set; }

        [Required(ErrorMessage = "Es necesario especificar el dato Acta de sesión de Comité de Administración con asignacion de cargos directivos")]
        [Display(Name = "(*) Acta de sesión de Comité de Administración con asignacion de cargos directivos")]
        [DataType(DataType.Upload)]
