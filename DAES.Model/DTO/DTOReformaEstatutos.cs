...
{
    public class DTOReformaEstatutosCooperativa : DTOSolicitante
    {
        public DTOReformaEstatutosCooperativa()
        {
        }
        ...
        [Required(ErrorMessage = "Es necesario especificar el dato Copia autorizada de la Escritura Pública en la cual se contiene el acta de la Junta General de Socios que aprobó la Reforma del Estatuto Social")]
        [Display(Name = "Copia autorizada de la Escritura Pública en la cual se contiene el acta de la Junta General de Socios que aprobó la Reforma del Estatuto Social")]
        ...
        [Required(ErrorMessage = "Es necesario especificar el dato Estatuto refundido")]
