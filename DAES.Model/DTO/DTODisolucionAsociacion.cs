...
{
    public class DTODisolucionAsociacion : DTOSolicitante
    {
        public DTODisolucionAsociacion()
        {
        }
        ...
        [Required(ErrorMessage = "Es necesario especificar el dato Acta de asamblea de socios donde conste la disolución")]
        [Display(Name = "Acta de asamblea de socios donde conste la disolución")]
        ...
        [Required(ErrorMessage = "Es necesario especificar el dato Listado de asistencia a asamblea")]
        [Display(Name = "Listado de asistencia a asamblea")]
        [DataType(DataType.Upload)]
        public HttpPostedFileBase File3 { get; set; }

        [Required(ErrorMessage = "Es necesario especificar el dato Extracto disolución")]
        [Display(Name = "Extracto disolución")]
        [DataType(DataType.Upload)]
